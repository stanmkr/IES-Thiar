...
public class RectanguloPruebas {
    public static void main(String[] args) {
        ...
        Rectangulo rectanguloPrueba = new Rectangulo(0,0,0,0);
        rectanguloPrueba.imprimir();
        rectanguloPrueba.setAll(2,-1,1,0);
        rectanguloPrueba.imprimir();

        Rectangulo aleatorio = Rectangulo.creaRectanguloAleatorio();
        aleatorio.imprimir();
